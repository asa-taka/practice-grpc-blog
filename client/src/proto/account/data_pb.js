...
goog.exportSymbol('proto.account.User.Status', null, global);
...
proto.account.User.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = /** @type {!proto.account.User.Status} */ (reader.readEnum());
      msg.setStatus(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!proto.account.User.Status}
 */
proto.account.User.prototype.getStatus = function() {
  return /** @type {!proto.account.User.Status} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};


/** @param {!proto.account.User.Status} value */
proto.account.User.prototype.setStatus = function(value) {
